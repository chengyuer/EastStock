...
class DmozSpider(CrawlSpider):
    ...
    def start_requests(self):
        ...
        for stock in stocks[:20]:
            myItem = example.items.StockItem()
            stock = stock.replace("\n", "")
            ...
            myItem['name'] = name
            myItem['num'] = num
            requestsList.append(scrapy.Request(url='http://istock.jrj.com.cn/list,'+num+',p1.html',meta={'meta':myItem},headers=headers,callback=self.parse_title))
        return requestsList
